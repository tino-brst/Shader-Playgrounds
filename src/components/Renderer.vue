<template>
  <div class="renderer">
    <canvas
      ref="canvas"
      :class="{ visible: modelsLoaded && windowReady }"
    />
    <div
      v-if="windowReady"
      class="compilation-info"
      :class="{ visible: ! compilationSucceeded || ! compiledAtLeastOnce }"
    >
    ...
    >
      <v-progress-bar
        :done="modelsLoaded && texturesLoaded"
        info="Loading models & textures"
        ref="progressBar"
      />
